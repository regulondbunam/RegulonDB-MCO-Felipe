...
def genOutFile(onto):
    ...
    for onto_class in onto_classes:  # Terms iterator
        ...
        try:
            ...
            # Description concat
            description = str(onto_class.description + onto_class.MCO_0000382)
            ...
            terms_properties["createdBy"] = {
                k: v for k, v in terms_properties["createdBy"].items() if v
            }
