...
class Identifiers(object):
    multigenomic_acronyms = {
        ...
        "term": "TR",
        "terminator": "TM",
        "transcriptionFactorRegulatorySite": "BS",
    ...
    def get_next_sequence_value(self, entity=None, size=1):
        ...
        next_sequence_value = "0" * (5 - len(next_sequence_value)) + next_sequence_value
    ...
    def get_identifier_of(self, source_id, entity=None):
        ...
        if source_id:
            ...
            if entity is not None:
                query['type'] = entity
            response = self.identifier_collection.find_one(query, {"_id", "sourceObject_id"})
            if response:
                response = {
    ...
    def get_regulatory_interaction_identifiers(self):
        identifiers_mapping = {
            ...
            "transcriptionFactorRegulatorySite": self.get_identifiers_of("transcriptionFactorRegulatorySite")
        }
        return identifiers_mapping
    ...
    def create_identifier_for(self, source_object_data=None, entity=None):
        ...
        identifier = self.build_identifier_object(source_object_data, next_sequence_value)
        print(identifier)
